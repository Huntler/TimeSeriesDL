...
class DecoderVanilla(DecoderBase):
    def __init__(self, dec_feature_size, dec_target_size, hidden_dim, 
        ...
        self.gru = nn.GRU(dec_feature_size, hidden_dim, num_gru_layers, batch_first=True, dropout=dropout)
        self.out = nn.Linear(hidden_dim + dec_feature_size, dec_target_size * dist_size)
